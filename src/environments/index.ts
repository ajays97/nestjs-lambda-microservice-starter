...
// database
const DATABASE_TYPE: string = process.env.DATABASE_TYPE || 'postgres';
const DATABASE_HOST: string = process.env.DATABASE_HOST || 'localhost';
const DATABASE_USER: string = process.env.DATABASE_USER || 'ajay';
const DATABASE_PASS: string = process.env.DATABASE_PASS || 'ajayajay';
const DATABASE_PORT: number = parseInt(process.env.DATABASE_PORT);
const DATABASE_NAME: string =
  process.env.DATABASE_NAME || 'flippy-test-database';
